...
def parse_arguments():
    ...
    parser.add_argument("--mole_num_general_expert", type=int, default=1)
    ...
    parser.add_argument("--stage_lr_ratio", type=float, default=1.0, help="Stage learning rate ratio")
    ...
    parser.add_argument("--gating", type=str, default="softmax", choices=["softmax", "sigmoid", "tanh"], help="Gate mechanism for MoLE")
    ...
    parser.add_argument('--cl_aug', choices=["dropout", "shuffle", "RTR", "none"])
    parser.add_argument('--sub_max', action='store_true')
    parser.add_argument('--leave_zero', action='store_true')
    parser.add_argument('--single_label', action='store_true')
    parser.add_argument('--aug_repeat_times', type=int, default=1)
    parser.add_argument('--joint_da_loss', default="none", choices=["none", "ce", "dist", "mul"])
    parser.add_argument('--tlcl', action="store_true")
    parser.add_argument('--skip_first_cl', choices=["ucl", "tlcl", "ucl+tlcl", "none"], default="none")
