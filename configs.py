...
def parse_arguments():
    ...
    parser.add_argument('--adamw_eps', default=1e_7)
    ...
    parser.add_argument('--backbone', default='bert_base_uncased', help='Feature extractor')
    parser.add_argument('--lr',type=float, default=2e_5)
    parser.add_argument('--decay', type=float, default=1e_4, help="")
